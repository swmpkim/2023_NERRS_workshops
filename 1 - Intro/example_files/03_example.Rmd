...
RMarkdown and Quarto both enable you to weave together content and executable code into a finished document. 
...
In the final rendered document, you show only the results of the code, not the code itself, by using a special "chunk option". These are handled a little differently in RMarkdown than in Quarto.  
